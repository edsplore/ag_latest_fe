...
import { ArrowLeft, CreditCard, History, DollarSign, Download, Plus } from 'lucide-react';
...
const Billing: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-dark-300 flex justify-center items-center text-white">
        <motion.div
        ...
        >
          ...
          <span className="text-lg font-medium">Loading billing information...</span>
        </motion.div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-dark-300 text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              <Link
                to="/dashboard"
                className="p-2 text-gray-400 hover:text-primary rounded-lg hover:bg-dark-200 transition-colors"
              >
            ...
            {hasPaymentMethod ? (
              <div className="bg-green-500/10 text-green-400 px-4 py-2 rounded-lg flex items-center space-x-2 text-sm font-medium border border-green-500/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="bg-dark-200 rounded-xl border border-dark-100 p-6">
          ...
          <div className="lg:col-span-3">
            {currentPlan ? (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-dark-200 rounded-xl border border-dark-100 p-6"
              >
                <h2 className="text-xl font-semibold text-white mb-4">Current Plan</h2>
                <div className="p-6 rounded-lg border border-primary/20 bg-primary/5">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-xl font-medium text-white">{currentPlan.name}</h3>
                  ...
                  {plans.map((plan, idx) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          backgroundColor: isEven ? "#155EEF" : "#1a1d21",
              ...
              <tbody className="divide-y divide-dark-100">
                {pastInvoices.length === 0 ? (
                  ...
                  pastInvoices.map((invoice) => (
                    <tr key={invoice.id} className="hover:bg-dark-300/50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <a
                          ...
                          className="text-primary hover:text-primary-400 flex items-center text-sm font-medium transition-colors"
                        >
